...
# Bot18 - Mixed style: Alternate left/right EDs (bot1 + bot12/13 interleaved)
# Drop 1 left, 1 right, 1 left, 1 right... covering both sides simultaneously
...
print("Bot18 | Style: Alternating Left-Right EDs")
    ...
    try:
        ...
        if location is not None:
            ...
            if target_image == '(3)Attack!.png':
                ...
                time.sleep(4.14)
                # 1 ED - left side pos 1 (bot1)
                pyautogui.click(639, 902)
                time.sleep(0.25)
                # 2 ED - right side pos 1 (bot12/13)
                pyautogui.click(1256, 169)
                time.sleep(0.25)
                # 3 ED - left side pos 2 (bot1)
                pyautogui.click(552, 841)
                time.sleep(0.25)
                # 4 ED - right side pos 2 (bot12/13)
                pyautogui.click(1345, 240)
                time.sleep(0.25)
                # 5 ED - left side pos 3 (bot1)
                pyautogui.click(478, 760)
                time.sleep(0.25)
                # 6 ED - right side pos 3 (bot12/13)
                pyautogui.click(1436, 315)
                time.sleep(0.25)
                # 7 ED - left side pos 4 (bot1)
                pyautogui.click(397, 706)
                time.sleep(0.25)
                # 8 ED - right side pos 4 (bot12/13)
                pyautogui.click(1506, 371)
                time.sleep(0.25)
                # 9 ED - left side pos 5 (bot1)
                pyautogui.click(321, 639)
                time.sleep(0.25)
                # 10 ED - right side pos 5 (bot12/13)
                pyautogui.click(1577, 413)
                time.sleep(0.25)
                # 11 ED - left side pos 6 (bot1)
